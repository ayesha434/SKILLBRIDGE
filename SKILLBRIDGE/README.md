...
🌐 **Live Demo:** [https://skill-share.infinityfreeapp.com/index.php](https://skill-share.infinityfreeapp.com/index.php)
...
```
https://skill-share.infinityfreeapp.com/index.php
```

> Hosted on **InfinityFree** free hosting. If the site is temporarily unavailable, it may be due to free hosting limitations (traffic limits, sleep mode, etc.).
...
For the live deployment, `BASE_URL` should be set to:
```php
define('BASE_URL', '/');
```
And the database credentials in `config/db.php` should point to the InfinityFree MySQL host, database name, username, and password provided in your hosting control panel.
